...
export function Hero() {
  return (
    <section className="relative min-h-[650px] overflow-hidden bg-[#061a35]">
      <Image src="/images/hero-sports.webp" alt="Friends watching live football with krooz tv IPTV" fill priority className="scale-[1.02] object-cover" sizes="100vw" />
      ...
      <Container className="relative z-10 flex min-h-[650px] flex-col items-center justify-center py-16 text-center text-white sm:py-20">
        <h1 className="max-w-4xl break-words text-4xl font-extrabold leading-[1.12] tracking-[-0.025em] md:text-5xl lg:text-[54px]">krooz tv IPTV Subscription for Live TV, Sports & Entertainment</h1>
