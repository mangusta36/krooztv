    ...
    <section className="grid min-h-[420px] overflow-hidden bg-[#819a90] lg:grid-cols-2">
      <div className="flex items-center px-6 py-16 text-white sm:px-12 lg:justify-end lg:py-20">
        <div className="w-full max-w-[580px]">
          ...
          <h2 className="mt-5 text-4xl font-extrabold leading-tight tracking-[-0.025em] md:text-5xl">Try krooz tv Before Choosing a Plan</h2>
          <p className="mt-4 text-lg text-white/85">Explore live and on-demand viewing on a compatible device before subscribing.</p>
      ...
      <div className="relative min-h-[360px]">
        <Image src="/images/family-living-room.webp" alt="Family using IPTV-compatible devices in a living room" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
